...
ic = pygame.image.load("images/snake logo.png")
...
game_board = pygame.image.load("images/Snakes_ladders_big_image.png")
...
menu_background = pygame.image.load("images/introduction.png")
post = pygame.image.load("images/background.png")


#including the necessary background images
initial_background = pygame.image.load("images/opening.png")
initial_background1 = pygame.image.load("images/introduction1.png")
initial_background2 = pygame.image.load("images/introduction2.png")
inital_background3 = pygame.image.load("images/introduction3.png")
initial_background4 = pygame.image.load("images/introduction4.png")
creditations1 = pygame.image.load("images/CREDITS.png")

#adding music to the game
snake_sound = pygame.mixer.Sound("audios/snake.wav")
sound = pygame.mixer.music.load("audios/music2.wav")
win = pygame.mixer.Sound("audios/win.wav")
lose = pygame.mixer.Sound("audios/lose.wav")
ladder = pygame.mixer.Sound("audios/ladder.wav")
...
def msg_display_scr(text,x,y,fs):
    ...
    TextSurf, TextRect = text_obj_scr(text, largeTxt, white_c)
    TextRect.center = (x,y)
...
def movement(a):
    l1 = [[406, 60], [456, 606], [506, 606], [556, 606], [606, 606], [656, 606], [706, 606], [756, 606], [806, 606],
